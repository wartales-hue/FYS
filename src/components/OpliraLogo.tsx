...
export const OpliraLogo: React.FC<OpliraLogoProps> = ({
  ...
  return (
    <div className={`inline-flex items-center gap-2.5 ${className}`}>
      {/* Oplira Icon SVG perfectly matching the brand emblem */}
      <svg
        width={size}
        height={size}
        viewBox="0 0 120 120"
      ...
      >
        ...
        {/* Digital Cursive Signature 'li' on Screen */}
        <path
        ...
        {/* Hand touching the smartphone screen */}
        <g id="hand-touch">
          {/* Index Finger pointing/touching screen */}
          <path
